// Example program #2 from Chapter 22

// This program fills three arrays with a player's total points, rebounds, and
// assists. It loops through the scoring array and finds the game with the most
// points. Once it knows that information, it prints the totals from all three
