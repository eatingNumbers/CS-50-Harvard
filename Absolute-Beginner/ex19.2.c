// Example Program #2 from Chapter 19 of Absolute Beginner's Guide to C, 3rd
// Edition

// This program asks a user for their hometown and the two-letter abbreviation
// of their home state. It then uses string concatenation to build a new string
