...
int main(void) {
    ...
    printf("It's time to do your homework!\n");
    ...
    printf("The cosine of a 90-degree angle is %.3f\n", cos((90*(3.14159/180.0))));
    printf("The cosine of a 75-degree angle is %.3f\n", cos((75*(3.14159/180.0))));
    printf("The cosine of a 45-degree angle is %.3f\n", cos((45*(3.14159/180.0))));
    printf("The cosine of a 30-degree angle is %.3f\n", cos((30*(3.14159/180.0))));
    printf("The cosine of a 15-degree angle is %.3f\n", cos((15*(3.14159/180.0))));
