// Example program #1 from Chapter 22

// This program takes an ID number from the user and then checks the ID against
// a list of customers in the database. If the customer exists, it uses that
// array element to check their current balance, and warns the user if the
